...
#
# Description:  dataframe.utils — Core utilities for Momijo DataFrame (string ops, numeric parsing,
#               dtype inference, boolean masks, selection/take, argsort, unique/distinct,
#               simple stats and predicates). All functions are allocation-aware and cache-friendly.
#
...
#
# Notes:
#   - Structs: ConstVal, Pred, Ops, Column (if present in this file) — kept minimal and copy/move safe.
#   - Key functions: infer_dtype, parse_f64, sqrt64, compute_stats, percentile_f64, argsort_f64,
#                    expanding_corr_last, between_i64, df_distinct (and helpers).
