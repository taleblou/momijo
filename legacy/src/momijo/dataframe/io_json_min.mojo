...
#               Column-oriented JSON and JSON Lines (records) serializers/parsers,
#               with safe escaping and simple read/write helpers.
#
...
#   - Key functions: json_escape, json_unescape, to_json_string, from_json_string,
