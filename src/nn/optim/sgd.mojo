...
#
# Module: momijo.nn.sgd
# Path:   src/momijo/nn/sgd.mojo
#
# Stochastic Gradient Descent (SGD) optimizer — dependency-light.
#
# Features:
#   - Supports Param1D / Param2D
#   - Momentum and Nesterov momentum
#   - Weight decay (L2) in two modes:
#       * coupled (classic): g += wd * p
#       * decoupled (AdamW-style): p -= lr * wd * p
...
struct SGD:
    ...
    fn __init__(out self, lr: Float64 = 1e-2, momentum: Float64 = 0.0, dampening: Float64 = 0.0, weight_decay: Float64 = 0.0, nesterov: Bool = False, decoupled_wd: Bool = False):
        self.lr = lr
    ...
    fn set_momentum(mut self, m: Float64): self.momentum = m
