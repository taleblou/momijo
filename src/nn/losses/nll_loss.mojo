...
#
# Module: momijo.nn.nll_loss
# Path:   src/momijo/nn/nll_loss.mojo
#
# Negative Log-Likelihood Loss (expects log-probabilities as input).
# Features:
#   - reduction: "mean" | "sum" | "none"
#   - class weights (per-class)
#   - ignore_index (excluded from loss & mean denominator)
#
# Shapes supported:
#   - 1D: log_probs[List[Float64]] and target index (Int)
#   - 2D: log_probs[List[List[Float64]]] with targets[List[Int]] (class indices)
#
# Momijo style:
