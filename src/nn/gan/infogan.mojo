...
#
# Module: momijo.nn.gan.infogan
# Path:   src/momijo/nn/gan/infogan.mojo
#
# InfoGAN (Chen et al. 2016) — compact, dependency-light scaffold.
# Maximizes mutual information I(c; G(z, c)) via variational lower bound
# using an auxiliary network Q(c | x) sharing parameters with D.
#
# This educational scaffold uses List[Float64] math to avoid heavy deps.
# Replace internals with real tensor ops when wiring to momijo.tensor.*.
#
# Momijo style:
...
# Gaussian negative log-likelihood for continuous code c ~ N(mu, sigma^2)
...
struct Generator:
    ...
    fn __init__(out self, z_dim: Int, cat_dim: Int, cont_dim: Int, hidden_dim: Int, x_dim: Int):
...
struct DQ:
    ...
    fn __init__(out self, x_dim: Int, hidden_dim: Int, cat_dim: Int, cont_dim: Int):
...
struct InfoGAN:
    ...
    fn __init__(out self, z_dim: Int, cat_dim: Int, cont_dim: Int, g_hidden: Int, dq_hidden: Int, x_dim: Int, lambda_mi: Float64 = 1.0):
