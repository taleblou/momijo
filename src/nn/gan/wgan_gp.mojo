...
#
# Module: momijo.nn.gan.wgan_gp
# Path:   src/momijo/nn/gan/wgan_gp.mojo
#
# Wasserstein GAN with Gradient Penalty (WGAN-GP) — compact scaffold.
# Based on WGAN but with a stronger GP (sampling uniformly along real/fake line).
# Dependency-light (List[Float64]) with finite-difference proxy gradient norm.
#
# Momijo style:
