...
#
# Module: momijo.nn.gan.penalties
# Path:   src/momijo/nn/gan/penalties.mojo
#
# Gradient penalty utilities for educational GANs (WGAN-GP, DRAGAN, R1/R2-like proxies).
# Dependency-light (List[Float64]) with finite-difference approximations.
#
# Momijo style:
...
struct Penalties:
    ...
    fn __init__(out self, lambda_gp: Float64 = 10.0, eps_fd: Float64 = 1e-3, perturb_scale: Float64 = 0.5):
