...
#
# Module: momijo.nn.gan.dragan
# Path:   src/momijo/nn/gan/dragan.mojo
#
# DRAGAN (Gradient penalty around the data manifold) — compact scaffold.
# We implement a dependency-light version using Lists + Float64 and
# a finite-difference directional-derivative proxy for the gradient norm.
#
# Momijo style:
...
struct DRAGAN:
    ...
    fn __init__(out self, z_dim: Int, x_dim: Int, g_hidden: Int, d_hidden: Int, lambda_gp: Float64 = 10.0, perturb_scale: Float64 = 0.5, eps_fd: Float64 = 1e-3):
