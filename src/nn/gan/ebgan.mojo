...
#
# Module: momijo.nn.gan.ebgan
# Path:   src/momijo/nn/gan/ebgan.mojo
#
# Energy-Based GAN (EBGAN) — compact, dependency-light scaffold.
# Discriminator is an autoencoder; its scalar "energy" is a reconstruction loss.
# Generator tries to produce samples with low energy; D uses margin hinge.
#
# Momijo style:
...
struct EBGAN:
    ...
    fn __init__(out self, z_dim: Int, x_dim: Int, g_hidden: Int, d_hidden: Int, margin: Float64 = 1.0):
