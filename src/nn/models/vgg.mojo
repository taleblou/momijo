...
#
# Module: momijo.nn.vgg
# Path:   src/momijo/nn/vgg.mojo
#
# Minimal VGG-like CNN (Tiny) for pedagogy/smoke tests.
# Self-contained, list-based Float64 math. Supports CHW and NCHW.
#
# Tiny configuration (CIFAR-like 32x32 friendly):
#   Block1: conv3x3(3->64)      + ReLU + MaxPool2x2
#   Block2: conv3x3(64->128)    + ReLU + MaxPool2x2
#   Block3: conv3x3(128->256)x2 + ReLU + MaxPool2x2
#   Head: GlobalAvgPool -> Linear(256 -> num_classes)
#
# Momijo style:
...
struct VGGBlock:
    ...
    fn __init__(out self, in_ch: Int, out_ch: Int, nconv: Int):
        self.in_ch = in_ch
        self.out_ch = out_ch
        self.nconv = nconv
