...
#
# Module: momijo.nn.attention
# Path:   src/momijo/nn/attention.mojo
#
# Minimal, dependency-light attention utilities for pedagogy/smoke tests.
# Implemented with List[List[Float64]] (2D) and List[Float64] (1D).
#
# Momijo style:
