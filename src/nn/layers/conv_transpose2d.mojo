...
#
# Module: momijo.nn.conv_transpose2d
# Path:   src/momijo/nn/conv_transpose2d.mojo
#
# Minimal ConvTranspose2d (a.k.a. deconvolution) for pedagogy/smoke tests.
# List-based implementation (Float64) with:
#   - Single image [C_in, H, W] and batch [N, C_in, H, W]
#   - Stride, padding, and output_padding (no dilation, no groups)
#   - Weights shaped as [C_in][C_out][kh][kw] (note the order)
#
# Momijo style:
...
struct ConvTranspose2d:
    ...
    fn __init__(out self, in_channels: Int, out_channels: Int, kernel_h: Int, kernel_w: Int, stride_h: Int = 1, stride_w: Int = 1, pad_h: Int = 0, pad_w: Int = 0, out_pad_h: Int = 0, out_pad_w: Int = 0, bias: Bool = True, w_init: Float64 = 0.01):
