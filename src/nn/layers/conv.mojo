...
#
# Module: momijo.nn.conv
# Path:   src/momijo/nn/conv.mojo
#
# Minimal convolution utilities (2D) for pedagogy/smoke tests.
# Works on nested Lists (Float64). Supports:
#   - Single image 2D (C,H,W) and batch (N,C,H,W)
#   - Stride and zero padding (no dilation, no groups)
#   - Conv2d struct with weights [out_ch][in_ch][kh][kw] and optional bias
#
# Momijo style:
...
struct Conv2d:
    ...
    fn __init__(out self, in_channels: Int, out_channels: Int, kernel_h: Int, kernel_w: Int, stride_h: Int = 1, stride_w: Int = 1, pad_h: Int = 0, pad_w: Int = 0, bias: Bool = True, w_init: Float64 = 0.01):
