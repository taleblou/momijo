...
#
# Module: momijo.nn.rnn
# Path:   src/momijo/nn/rnn.mojo
#
# Minimal recurrent layers (RNN/GRU/LSTM) for pedagogy & smoke tests.
# List-based Float64 implementation; sequence is List[List[Float64]] with
# shape [T][input_dim]. Batch support is omitted for clarity.
#
# Momijo style:
