...
#
# Module: momijo.nn.groupnorm
# Path:   src/momijo/nn/groupnorm.mojo
#
# Minimal Group Normalization (GN) for pedagogy/smoke tests.
# Works on nested Lists (Float64). Supports 3D [C,H,W] and 4D [N,C,H,W].
# No running stats (unlike BatchNorm). Affine per-channel gamma/beta.
#
# Momijo style:
...
struct GroupNorm:
    ...
    fn __init__(out self, num_groups: Int, num_channels: Int, eps: Float64 = 1e-5, affine: Bool = True):
