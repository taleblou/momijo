...
#
# NOTE: This file follows the user's strict Mojo checklist:
# - Project structure: src/momijo/... ; examples/tests separate
# - No 'export', no global mutable state
# - Only 'var' (no 'let')
# - Constructors use `fn __init__(out self, ...)`
# - Prefer mut/out over inout; no 'inout' in signatures
# - Traits where necessary; avoid ambiguous overloads
# - Printing via String(...) only in examples/tests (none here)
# - English comments; no non-English text
...
# -------------------------------
# Safe float parsing (Float64) — minimal
# -------------------------------
