...
#
# Project: momijo.ir
# File: src/momijo/ir/codegen_rocm.mojo
# Description: ROCm/HIP (GPU) code generator for Momijo HLIR/core-IR (textual C++/HIP).
# Notes:
#   - Self-contained fallback IR model to keep this file runnable in isolation.
#   - Generates elementwise 1-D kernels when return type is tensor<*,[N]>.
#   - Scalars supported as kernel parameters (broadcast within threads).
#   - No globals, no 'export'; only 'var' (no 'let'). Constructors with '__init__'.
# ============================================================================
