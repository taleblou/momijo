...
#
# Project: momijo.ir
# File: src/momijo/ir/codegen_cpu.mojo
# Description: CPU code generator (C-like textual output) for Momijo HLIR/core-IR.
# Notes:
#   - Self-contained fallback IR model to keep this file runnable in isolation.
#   - Targets simple C-like code for scalar ops (i64, f64, bool). Tensors: placeholder.
...
struct CodegenOptions:
    ...
    fn __init__(out self, emit_header: Bool = True, include_stdbool: Bool = True, indent_size: Int = 4):
