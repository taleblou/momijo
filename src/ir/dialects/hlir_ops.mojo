...
#
# Project: momijo.ir
# File: src/momijo/ir/hlir_ops.mojo
# Description: High-Level IR (HLIR) ops and helpers on top of core IR model.
# Notes:
#   - Self-contained fallback IR model to keep this file runnable in isolation.
#   - No globals, no 'export'; only 'var' (no 'let').
#   - Constructors are 'fn __init__(out self, ...)'.
#   - Provide typed emitters with simple type inference and checks.
# ============================================================================

# -----------------------------
# Core IR (fallback view)
# -----------------------------
