...
#
# Project: momijo.ir
# File: src/momijo/ir/shape_inference.mojo
# Description: Shape & type inference utilities for HLIR/core IR operations.
# Notes:
#   - Self-contained (no external imports) to keep runnable in isolation.
#   - Only 'var' (no 'let'); constructors use 'fn __init__(out self, ...)'.
#   - Uses a minimal TypeDesc/DType/Shape and a 'tensor<DTYPE,[...]>' encoding.
# ============================================================================

# -----------------------------
# Minimal type & shape model
# -----------------------------
...
struct Perm:
    var idx: List[Int]
    fn __init__(out self): self.idx = List[Int]()
...
# -----------------------------
# slice(x, starts, sizes) – simplified: output sizes as given
# -----------------------------

struct IntVec:
    var data: List[Int]
    fn __init__(out self): self.data = List[Int]()
