...
#
# Project: momijo.ir
# File: src/momijo/ir/hlir_to_midir.mojo
# Description: Lowering pass from HLIR to MIDIR (core/portable IR).
# Notes:
#   - Self-contained fallback IR model; no globals, no 'export'; only 'var' (no 'let').
#   - Copies function signatures and block structure; re-emits ops with mid.* names.
#   - Preserves TypeDesc names; constants keep "value=" attribute as-is.
#   - Comparison ops get predicate attribute: {pred="EQ|LT|GT"}.
#   - Select lowered 1:1. Return lowered to mid.ret.
#   - Provides a tiny printer and a self-test in main() that must print OK.
# ============================================================================
