...
# Description: Minimal, production-ready IR Builder for Momijo with safe patterns.
# Notes:
#   - No globals, no 'export', only 'var' (no 'let').
#   - Constructors: fn __init__(out self, ...)
#   - Traits & generics: prefer Copyable & Movable when needed.
#   - Printing via String(...) only; avoid printing complex structs directly.
#   - This file is self-contained (no external imports besides stdlib basics).
# ============================================================================

# -----------------------------
# Core primitive "IR" concepts
# -----------------------------
...
struct Operand:
    ...
    fn __init__(out self, value: Value):
        self.value = value
