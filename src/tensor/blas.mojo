...
# File: momijo/tensor/blas.mojo

from momijo.tensor.tensor import Tensor  # generic in your codebase

# --- helpers (no-op stubs to keep file compiling) -----------------------------
