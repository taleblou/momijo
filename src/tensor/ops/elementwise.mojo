...
# File: momijo/tensor/ops/elementwise.mojo
...
# NOTE: نسخهٔ امن بدون جنریک (سازگار با پارسر فعلی Mojo)
...
fn add_f64(a: F64Tensor, b: F64Tensor) -> F64Tensor:
    # اگر registry_add پلی‌مورفیک است، همین امضا کافی است
    # اگر نیاز به پارامتر نوع دارد:
