...
# File: src/momijo/vision/convert_color.mojo
#
# High-level color-conversion helpers for Momijo Vision.
# Standalone & dependency-light facade that works on raw UInt8/HWC buffers
# and a minimal Image container defined here (to avoid imports).
# Style: no 'export', no 'let', no 'inout'. Constructors use `fn __init__(out self, ...)`.
#
# Implemented ops:
#   - bgr_to_rgb_u8_hwc / rgb_to_gray_u8_hwc / rgba_to_rgb_u8_hwc / bgra_to_bgr_u8_hwc
#   - argmin_channel_u8_hwc (3-channel input)
#   - Image wrappers: apply_* that take/return Image
#
# Notes:
# - These mirror the kernels in backend/cpu/*.mojo, duplicated here to keep this
#   file self-contained for early integration. When module wiring is ready, this
#   facade can dispatch to CPU/SIMD backends based on a flag/capability query.

# -------------------------
# Lightweight Image (U8/HWC)
# -------------------------
