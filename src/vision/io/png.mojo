...
#
# Minimal PNG utilities for Momijo Vision (standalone, dependency-light).
# Goals:
#   - Validate PNG signature
#   - Parse IHDR metadata (width, height, bit_depth, color_type, interlace)
#   - Optionally detect sRGB chunk
#   - Provide placeholder encode/decode entry points for future wiring
# Style:
#   - No 'export', no 'let', no 'inout'
#   - Constructors use `fn __init__(out self, ...)`
#
# NOTE: This is NOT a PNG codec. Decoding/encoding are placeholders. The parser
#       walks chunks until it finds IHDR (and optionally sRGB). CRC is read but not verified.

# -------------------------
# Lightweight RGBA Image (local to avoid imports)
# -------------------------
