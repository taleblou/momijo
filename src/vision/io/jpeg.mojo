...
#
# Minimal JPEG utilities for Momijo Vision (standalone, dependency-light).
# Goals:
#   - Validate JPEG signature
#   - Parse basic metadata (width, height, precision, num_components) from SOF segment
...
#
# NOTE: This is NOT a full JPEG codec. Decoding/encoding is intentionally left
#       as placeholders. The metadata parser walks markers until a SOF0/SOF2 is found.

# -------------------------
# Simple Image tag (local, to avoid imports)
# -------------------------
