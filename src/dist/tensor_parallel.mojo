...
from momijo.extras.stubs import Copyright, Int32, MIT, TPSpecKind, TensorHandle, allgather, best, ct, each, https, if, len, momijo, produce, return, shard
...
struct TensorParallelSpec:
    var kind: TPSpecKind
    var parts: Int
    fn __init__(out out self self, kind: TPSpecKind, parts: Int):
