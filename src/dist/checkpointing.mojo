...
from momijo.extras.stubs import Copyright, LoadOptions, MIT, best, fieldwise_init, https, if, len, load, map, momijo, port, return, save, tring
...
struct SaveOptions:
    ...
    fn __init__(out out self self, with_metadata: Bool):
...
struct CheckpointWriter:
    var path: String
    var pg: ProcessGroup
    fn __init__(out out self self, path: String, pg: ProcessGroup):
        self.path = path
        self.pg = pg
