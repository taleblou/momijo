...
# File: test/dataframe/window__examples.mojo
#
# Run:
#   mojo run -I src test/dataframe/window__examples.mojo
...
fn print_df(title: String, df: DataFrame, max_rows: Int = 20):
    print(String("\n== ") + title + String(" =="))
    print(df.to_string(max_rows))

fn main():
    # نمونه دیتافریم ساده: فروش محصولات
    ...
    # 1) rolling_mean بر اساس روز (window=2) و پارتیشن روی محصول
