...
# -----------------------------------------------------------------------------
# IterableDataset and DSIterator minimal stubs
# (these would normally live in momijo.io.datasets.iterable_dataset)
# -----------------------------------------------------------------------------
struct DSIterator:
    var data: List[Any]
    var pos: Int
...
struct DataPipe:
    ...
    fn __init__(out self, source: IterableDataset):
        self.source = source
