...
# -----------------------------------------------------------------------------
# Simple "Momijo Weight Package" (*.mnp) format:
#
# [header JSON length (8 bytes little-endian unsigned)]
# [header JSON UTF-8]
# [binary blobs concatenated]
#
# header JSON:
# { "params": [
#     {"name": str, "dtype": str, "shape": [int], "offset": int, "nbytes": int}
#   ]
# }
# -----------------------------------------------------------------------------


# Save state_dict to MNP file
fn save_mnp(filename: String, state: StateDict):
