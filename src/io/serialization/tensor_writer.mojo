...
# File: src/momijo/io/serialization/tensor_writer.mojo
# ============================================================================
...
# -----------------------------------------------------------------------------
# Write a single tensor to file (npy, safetensors, mnp)
# -----------------------------------------------------------------------------
fn write_tensor(path: String, tensor: Tensor):
...
# -----------------------------------------------------------------------------
fn write_tensors(path: String, tensors: Dict[String, Tensor]):
...
fn main():
    if _self_test():
        print("Tensor writer module self-test: OK")
    else:
        print("Tensor writer module self-test: FAIL")
