...
# Optional moved to stdlib: use from collections.optional import Optional
    ...
    fn __init__(out self self, present: Bool, value: T):
...
struct Pair[A, B](Copyable, Movable, EqualityComparable):
    ...
    fn __init__(out self self, first: A, second: B):
        self.first = first
        self.second = second
...
struct Triple[A, B, C](Copyable, Movable, EqualityComparable):
    ...
    fn __init__(out self self, first: A, second: B, third: C):
        self.first = first
        self.second = second
        self.third = third
...
struct Size(Copyable, Movable):
    ...
    var value: Int
    fn __init__(out self self, value: Int = 0):
...
struct Axis(Copyable, Movable):
    ...
    var index: Int
    fn __init__(out self self, index: Int = 0):
...
# Name moved to momijo.core.traits
    fn __init__(out self self, text: String = ""):
        self.text = text
...
# RangeI moved to momijo.core.traits
    ...
    fn __init__(out self self, start: Int = 0, stop: Int = 0, step: Int = 1):
        self.start = start
