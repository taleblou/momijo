...
from algorithm.reduction import sum as _std_sum

from algorithm.reduction import product as _std_product

from momijo.core.error import MomijoError
from momijo.core.result import Result
from builtin.dtype import DType
from momijo.core.shape import Shape
from momijo.core.shape import Strides
...
# Slice moved to momijo.core.shape
    ...
    fn __init__(out self self, start: Int = 0, stop: Int = -1, step: Int = 1):
        self.start = start
        self.stop = stop
