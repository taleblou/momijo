...
fn mul_same[T](a: Tensor[T], b: Tensor[T]) -> Result[Tensor[T]]:
...
# Backward (naive): dL/da = dy ⊙ b ; dL/db = dy ⊙ a
...
fn mul_backward_same[T](a: Tensor[T], b: Tensor[T], dy: Tensor[T]) -> (Tensor[T], Tensor[T]):
    # da = dy * b
