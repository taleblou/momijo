...
struct ParameterState(Copyable, Movable, EqualityComparable):
    var key: String
    var value: Tensor
    var grad: Tensor
    var has_grad: Bool
...
struct Parameter(Copyable, Movable, EqualityComparable):
    var tensor: Tensor
...
struct ParamHyper(Copyable, Movable, EqualityComparable):
    var lr: Float64
    var weight_decay: Float64
    var momentum: Float64

    fn __init__(out self, lr: Float64 = 1e-3, weight_decay: Float64 = 0.0, momentum: Float64 = 0.0):
        self.lr = lr
        self.weight_decay = weight_decay
        self.momentum = momentum


struct ParameterGroup(Copyable, Movable, EqualityComparable):
    var name: String
    var params: List[Parameter]
    var hyper: ParamHyper

    fn __init__(out self, name: String = "", params: List[Parameter] = List[Parameter](), hyper: ParamHyper = ParamHyper()):
        self.name = name
        self.params = params
        self.hyper = hyper
