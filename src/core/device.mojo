...
struct MemoryInfo(Copyable, Movable, EqualityComparable):
    var total_bytes: UInt64
    var free_bytes: UInt64

    fn __init__(out self, total_bytes: UInt64 = 0, free_bytes: UInt64 = 0):
...
struct DeviceId(Copyable, Movable, EqualityComparable):
    var value: Int
...
struct CPUDevice(Copyable, Movable, EqualityComparable):
    var _id: DeviceId
    var _name: String
    var _available: Bool
    var _mem: MemoryInfo
    ...
    fn __init__(out self, id: Int = 0, name: String = "cpu", available: Bool = True,
                mem_total: UInt64 = 0, mem_free: UInt64 = 0, num_threads: Int = 0):
...
struct CUDADevice(Copyable, Movable, EqualityComparable):
    var _id: DeviceId
    var _name: String
    var _available: Bool
    var _mem: MemoryInfo
    ...
    fn __init__(out self, id: Int = 0, name: String = "cuda", available: Bool = False,
                mem_total: UInt64 = 0, mem_free: UInt64 = 0, cc_major: Int = 0, cc_minor: Int = 0):
        self._id = DeviceId(value=id)
        self._name = name
        self._available = available
        self._mem = MemoryInfo(total_bytes=mem_total, free_bytes=mem_free)
...
struct MetalDevice(Copyable, Movable, EqualityComparable):
    var _id: DeviceId
    var _name: String
    var _available: Bool
    var _mem: MemoryInfo

    fn __init__(out self, id: Int = 0, name: String = "metal", available: Bool = False,
                mem_total: UInt64 = 0, mem_free: UInt64 = 0):
        self._id = DeviceId(value=id)
        self._name = name
        self._available = available
        self._mem = MemoryInfo(total_bytes=mem_total, free_bytes=mem_free)
...
struct VulkanDevice(Copyable, Movable, EqualityComparable):
    var _id: DeviceId
    var _name: String
    var _available: Bool
    var _mem: MemoryInfo

    fn __init__(out self, id: Int = 0, name: String = "vulkan", available: Bool = False,
                mem_total: UInt64 = 0, mem_free: UInt64 = 0):
        self._id = DeviceId(value=id)
        self._name = name
        self._available = available
...
struct TPUDevice(Copyable, Movable, EqualityComparable):
    var _id: DeviceId
    var _name: String
    var _available: Bool
    var _mem: MemoryInfo
    ...
    fn __init__(out self, id: Int = 0, name: String = "tpu", available: Bool = False,
                mem_total: UInt64 = 0, mem_free: UInt64 = 0, chip_rev: Int = 0):
        self._id = DeviceId(value=id)
        self._name = name
        self._available = available
        self._mem = MemoryInfo(total_bytes=mem_total, free_bytes=mem_free)
...
struct DeviceSpec(Copyable, Movable, EqualityComparable):
    var kind: DeviceKind
    var id: DeviceId

    fn __init__(out self, kind: DeviceKind = DeviceKind.cpu(), id: DeviceId = DeviceId(value=0)):
        self.kind = kind
        self.id = id
