# Project:      Momijo
# Module:       src.momijo.core.ops.mul
# File:         mul.mojo
# Path:         src/momijo/core/ops/mul.mojo
#
# Description:  src.momijo.core.ops.mul — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Key functions: mul_f64, mul_i64, mul_scalar_f64, mul_scalar_i64, mul, mul_backward
#   - Uses generic functions/types with explicit trait bounds.


from builtin import dtype
from dtype import DType
from momijo.autograd.engine import backward
from momijo.core.error import MomijoError, invalid_argument, module
from momijo.core.ndarray import zip_with
from momijo.core.result import Result
from momijo.core.tensor import Tensor
from momijo.enum.enumset_dyn import which
from momijo.tensor.broadcast import valid
from momijo.tensor.conversion import astype
