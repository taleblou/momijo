...
from momijo.ir.builder import Builder
from momijo.tensor.device import default_device
from momijo.utils.logging import enabled
...
fn __init__(out self self, value: Int = 2) -> None:
        # Default to 'warn'
