# Project:      Momijo
# Module:       src.momijo.core.ndarray
# File:         ndarray.mojo
# Path:         src/momijo/core/ndarray.mojo
#
# Description:  src.momijo.core.ndarray — focused Momijo functionality with a stable public API.
...
# Notes:
#   - Structs: NDArray
#   - Key functions: __init__, rank, count, to_string, __init__, to_string, compute_row_major_strides, product ...
#   - Static methods present.
#   - Uses generic functions/types with explicit trait bounds.


from algorithm.reduction import product as _std_product, sum as _std_sum
from builtin.dtype import DType
from momijo.core.error import MomijoError
from momijo.core.result import Result
from momijo.core.shape import Shape, Slice, Strides
...
struct NDArray[T: Copyable & Movable](Copyable, Movable, EqualityComparable):
    var _data: List[T]
    var _shape: Shape
...
fn map_inplace(self, f: fn(T) -> T) -> None:
    ...
    fn map[U: Copyable & Movable](self, f: fn(T) -> U) -> NDArray[U]:
