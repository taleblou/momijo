...
# Positional like OpenCV but min_dist as Float64 (گرد کردن به نزدیک‌ترین Int)
fn hough_circles(
    img: Image,
    dp: Float64,
    min_dist: Float64,
    ...
    var md = Int(min_dist + 0.5)
    return _hough_circles_impl(img, 0, dp, Float64(md), param1, param2, min_r, max_r)
