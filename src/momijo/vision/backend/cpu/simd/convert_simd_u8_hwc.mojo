...
fn simd_rgb_to_gray_u8_hwc(h: Int, w: Int, src: List[UInt8]) -> List[UInt8]:
    ...
    while y < h:
        ...
        while x + 3 < w:
            ...
            out[y * w + (x + 0)] = UInt8((g0_u16 >> UInt8(8)) & UInt16(0xFF))
            out[y * w + (x + 1)] = UInt8((g1_u16 >> UInt8(8)) & UInt16(0xFF))
            out[y * w + (x + 2)] = UInt8((g2_u16 >> UInt8(8)) & UInt16(0xFF))
            out[y * w + (x + 3)] = UInt8((g3_u16 >> UInt8(8)) & UInt16(0xFF))
