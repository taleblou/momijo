# Project:      Momijo
# Module:       src.momijo.vision.ops.resize
# File:         resize.mojo
# Path:         src/momijo/vision/ops/resize.mojo
#
# Description:  src.momijo.vision.ops.resize — focused Momijo functionality with a stable public API.
