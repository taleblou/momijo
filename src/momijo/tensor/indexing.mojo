...
@always_inline
fn min(self: Tensor[Float64]) -> Float64:
    var xs = self._data
    var n  = len(xs)
    if n == 0:
        return 0.0
...
@always_inline
fn max(self: Tensor[Float64]) -> Float64:
...
@always_inline
fn min(self: Tensor[Float32]) -> Float32:
    var xs = self._data
    var n  = len(xs)
    if n == 0:
        return 0.0
...
@always_inline
fn max(self: Tensor[Float32]) -> Float32:
    var xs = self._data.copy()
    var n  = len(xs)
    if n == 0:
        return 0.0
