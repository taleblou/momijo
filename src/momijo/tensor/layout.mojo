# Project:      Momijo
# Module:       src.momijo.tensor.layout
# File:         layout.mojo
# Path:         src/momijo/tensor/layout.mojo
#
...
#
# Notes:
#   - Structs: Strides, Layout, LayoutView
#   - Key functions: __module_name__, __self_test__, argmax_index, argmin_index, __init__, __init__, __copyinit__, for_c_contiguous ...
...
fn __init__(out self) -> None:
        self.vals = List[Int]()
fn __init__(out self, vals: List[Int]) -> None:
        self.vals = vals
...
struct Layout(Copyable, Movable):
    var shape: Shape
    var strides: Strides
fn __init__(out self, shape: Shape, strides: Strides) -> None:
        self.shape = shape
...
struct LayoutView(Copyable, Movable):
    var layout: Layout
    var offset: Int
fn __init__(out self, layout: Layout, offset: Int = 0) -> None:
        self.layout = layout
        self.offset = offset
fn __copyinit__(out self, other: Self) -> None:
