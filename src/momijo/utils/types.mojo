# Project:      Momijo
# Module:       src.momijo.utils.types
# File:         types.mojo
# Path:         src/momijo/utils/types.mojo
#
...
#
# Notes:
#   - Structs: Pair, Triple, Either, RangeI64, NonEmptyList
#   - Key functions: __init__, __init__, __copyinit__, swap, to_string, __init__, __init__, __copyinit__ ...
...
fn __init__(out self) -> None:
        self.first = T()
        self.second = U()
fn __init__(out self, a: T, b: U) -> None:
        self.first = a
        self.second = b
fn __copyinit__(out self, other: Self) -> None:
        self.first = other.first
        self.second = other.second
fn swap(mut self) -> None:
        var tmp = self.first
...
fn __init__(out self) -> None:
        ...
        self.b = B()
        self.c = C()
fn __init__(out self, a: A, b: B, c: C) -> None:
        self.a = a
        self.b = b
        self.c = c
fn __copyinit__(out self, other: Self) -> None:
...
fn __init__(out self) -> None:
        ...
        self.left = L()
        self.right = R()
fn __init__(out self, left: L, right: R, is_left: Bool) -> None:
...
fn __init__(out self) -> None:
        self.start = Int64(0)
        self.end = Int64(0)
fn __init__(out self, start: Int64, end: Int64) -> None:
        if end < start:
            self.start = end
            self.end = start
        else:
...
fn __init__(out self) -> None:
        self.xs = List[T]()
        self.nonempty = False
fn __init__(out self, xs: List[T]) -> None:
        self.xs = xs
