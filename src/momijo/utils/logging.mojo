# Project:      Momijo
# Module:       src.momijo.utils.logging
# File:         logging.mojo
# Path:         src/momijo/utils/logging.mojo
#
...
# Notes:
#   - Structs: Logger
#   - Key functions: _lvl_debug, _lvl_info, _lvl_warn, _lvl_error, _lvl_off, level_name, parse_level, _sanitize_line ...
