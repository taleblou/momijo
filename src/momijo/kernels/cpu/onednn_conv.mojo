# Project:      Momijo
# Module:       src.momijo.kernels.cpu.onednn_conv
# File:         onednn_conv.mojo
# Path:         src/momijo/kernels/cpu/onednn_conv.mojo
#
# Description:  src.momijo.kernels.cpu.onednn_conv — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Key functions: conv2d_naive, conv2d_onednn, _self_test
