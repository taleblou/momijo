# Project:      Momijo
# Module:       src.momijo.kernels.reference.matmul_ref
# File:         matmul_ref.mojo
# Path:         src/momijo/kernels/reference/matmul_ref.mojo
#
# Description:  src.momijo.kernels.reference.matmul_ref — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Key functions: matmul_ref, _self_test
