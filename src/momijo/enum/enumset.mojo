# Project:      Momijo
# Module:       src.momijo.enum.enumset
# File:         enumset.mojo
# Path:         src/momijo/enum/enumset.mojo
#
# Description:  src.momijo.enum.enumset — focused Momijo functionality with a stable public API.
...
# Notes:
#   - Structs: EnumSet
#   - Key functions: __init__, __len__, is_empty, clear, contains, add, remove, union ...


struct EnumSet(Copyable, Movable, Sized):
    var bits: UInt64
fn __init__(out self, bits: UInt64 = 0) -> None:
