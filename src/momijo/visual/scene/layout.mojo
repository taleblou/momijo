# Project:      Momijo
# Module:       src.momijo.visual.scene.layout
# File:         layout.mojo
# Path:         src/momijo/visual/scene/layout.mojo
#
# Description:  src.momijo.visual.scene.layout — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Structs: Margins, AxisSpec, Ticks, LinearScale, PlotLayout
