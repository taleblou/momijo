# Project:      Momijo
# Module:       src.momijo.visual.scene.facet
# File:         facet.mojo
# Path:         src/momijo/visual/scene/facet.mojo
#
# Description:  src.momijo.visual.scene.facet — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Structs: Rect, FacetSpec, FacetMapper, FacetLayout, NormPoint
#   - Key functions: __init__, __copyinit__, __moveinit__, __init__, __copyinit__, __moveinit__, facet_grid, facet_index ...
