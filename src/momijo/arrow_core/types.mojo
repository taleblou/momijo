# Project:      Momijo
# Module:       src.momijo.arrow_core.types
# File:         types.mojo
# Path:         src/momijo/arrow_core/types.mojo
#
...
# Notes:
#   - Structs: ArrowType
#   - Key functions: __module_name__, __self_test__, argmax_index, argmin_index, __copyinit__, to_int, from_int, INT ...
