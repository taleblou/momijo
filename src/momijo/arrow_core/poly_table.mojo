# Project:      Momijo
# Module:       src.momijo.arrow_core.poly_table
# File:         poly_table.mojo
# Path:         src/momijo/arrow_core/poly_table.mojo
#
...
# Notes:
#   - Structs: PolyTable
#   - Key functions: __module_name__, __self_test__, __init__, from_batches, __len__, n_batches, n_rows, n_columns ...
...
fn from_batches(mut self, bs: List[PolyRecordBatch]) -> None:
        self.batches = bs
...
fn get_column(self, name: String) -> List[String]:
    ...
    # ---------- Mutation ----------
fn add_batch(mut self, b: PolyRecordBatch) -> None:
