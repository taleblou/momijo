# Project:      Momijo
# Module:       src.momijo.arrow_core.value
# File:         value.mojo
# Path:         src/momijo/arrow_core/value.mojo
#
...
#
# Notes:
#   - Structs: ValueTag, Value
#   - Key functions: __module_name__, __self_test__, __init__, __copyinit__, INT, FLOAT64, STRING, BOOL ...
