# Project:      Momijo
# Module:       src.momijo.ir.llir.codegen_cpu
# File:         codegen_cpu.mojo
# Path:         src/momijo/ir/llir/codegen_cpu.mojo
#
# Description:  src.momijo.ir.llir.codegen_cpu — focused Momijo functionality with a stable public API.
