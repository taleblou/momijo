# Project:      Momijo
# Module:       src.momijo.ir.llir.codegen_cuda
# File:         codegen_cuda.mojo
# Path:         src/momijo/ir/llir/codegen_cuda.mojo
#
# Description:  src.momijo.ir.llir.codegen_cuda — focused Momijo functionality with a stable public API.
...
struct Kernel:
    var name: String
    var body: String
fn __init__(out self, name: String, body: String) -> None:
        self.name = name
        self.body = body
fn __copyinit__(out self, other: Self) -> None:
        self.name = other.name
...
fn __copyinit__(out self, other: Self) -> None:
        ...
        self.host_funcs = other.host_funcs
