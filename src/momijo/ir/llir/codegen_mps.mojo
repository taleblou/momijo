# Project:      Momijo
# Module:       src.momijo.ir.llir.codegen_mps
# File:         codegen_mps.mojo
# Path:         src/momijo/ir/llir/codegen_mps.mojo
#
# Description:  src.momijo.ir.llir.codegen_mps — focused Momijo functionality with a stable public API.
