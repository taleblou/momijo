# Project:      Momijo
# Module:       src.momijo.ir.dialects.hlir_ops
# File:         hlir_ops.mojo
# Path:         src/momijo/ir/dialects/hlir_ops.mojo
#
# Description:  src.momijo.ir.dialects.hlir_ops — focused Momijo functionality with a stable public API.
...
#   - Key functions: __init__, __copyinit__, __moveinit__, __init__, to_string, __copyinit__, __moveinit__, __init__ ...
