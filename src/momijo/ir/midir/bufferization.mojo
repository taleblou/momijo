# Project:      Momijo
# Module:       src.momijo.ir.midir.bufferization
# File:         bufferization.mojo
# Path:         src/momijo/ir/midir/bufferization.mojo
#
# Description:  src.momijo.ir.midir.bufferization — focused Momijo functionality with a stable public API.
