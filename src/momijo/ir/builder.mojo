# Project:      Momijo
# Module:       src.momijo.ir.builder
# File:         builder.mojo
# Path:         src/momijo/ir/builder.mojo
#
# Description:  src.momijo.ir.builder — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Structs: Location, TypeDesc, Value, Operand, Result, Op, Block, Function
