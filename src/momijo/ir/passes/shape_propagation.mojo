# Project:      Momijo
# Module:       src.momijo.ir.passes.shape_propagation
# File:         shape_propagation.mojo
# Path:         src/momijo/ir/passes/shape_propagation.mojo
#
# Description:  src.momijo.ir.passes.shape_propagation — focused Momijo functionality with a stable public API.
