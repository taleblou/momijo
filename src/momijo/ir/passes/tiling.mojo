# Project:      Momijo
# Module:       src.momijo.ir.passes.tiling
# File:         tiling.mojo
# Path:         src/momijo/ir/passes/tiling.mojo
#
# Description:  src.momijo.ir.passes.tiling — focused Momijo functionality with a stable public API.
