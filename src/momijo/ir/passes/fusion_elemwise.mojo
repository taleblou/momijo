# Project:      Momijo
# Module:       src.momijo.ir.passes.fusion_elemwise
# File:         fusion_elemwise.mojo
# Path:         src/momijo/ir/passes/fusion_elemwise.mojo
#
# Description:  src.momijo.ir.passes.fusion_elemwise — focused Momijo functionality with a stable public API.
