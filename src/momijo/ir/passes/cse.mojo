# Project:      Momijo
# Module:       src.momijo.ir.passes.cse
# File:         cse.mojo
# Path:         src/momijo/ir/passes/cse.mojo
#
# Description:  src.momijo.ir.passes.cse — focused Momijo functionality with a stable public API.
