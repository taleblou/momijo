# Project:      Momijo
# Module:       src.momijo.nn.training.checkpoint
# File:         checkpoint.mojo
# Path:         src/momijo/nn/training/checkpoint.mojo
#
...
#
# Notes:
#   - Structs: A1, A2, A3, A4, KV, Checkpoint
#   - Key functions: _abs, _min, _zeros1d, _zeros2d, _zeros3d, _zeros4d, _copy1d, _copy2d ...
...
fn __init__(out self, name: String = String(""), data: List[Float64]):
        self.name = name
        self.data = data
...
fn __init__(out self, name: String = String(""), data: List[List[Float64]]):
        self.name = name
        self.data = data
fn __copyinit__(out self, other: Self) -> None:
        self.name = other.name
...
fn __init__(out self, name: String = String(""), data: List[List[List[Float64]]]):
        self.name = name
        self.data = data
fn __copyinit__(out self, other: Self) -> None:
        self.name = other.name
...
fn __init__(out self, name: String = String(""), data: List[List[List[List[Float64]]]]):
        self.name = name
        self.data = data
fn __copyinit__(out self, other: Self) -> None:
        self.name = other.name
...
struct KV:
    var key: String
    var value: String
fn __init__(out self, key: String = String(""), value: String = String("")):
        self.key = key
...
fn __init__(out self) -> None:
    ...
    # ---- meta ----
fn add_meta(mut self, key: String, value: String) -> None:
        var kv = KV(key, value)
        self.meta.push(kv)

    # ---- add arrays (copying) ----
fn add_1d(mut self, name: String, data: List[Float64]) -> None:
        var x = _copy1d(data)
        var e = A1(name, x)
        self.a1.push(e)
fn add_2d(mut self, name: String, data: List[List[Float64]]) -> None:
        var x = _copy2d(data)
        var e = A2(name, x)
        self.a2.push(e)
fn add_3d(mut self, name: String, data: List[List[List[Float64]]]) -> None:
        var x = _copy3d(data)
        var e = A3(name, x)
        self.a3.push(e)
fn add_4d(mut self, name: String, data: List[List[List[List[Float64]]]]) -> None:
        var x = _copy4d(data)
        var e = A4(name, x)
        self.a4.push(e)
