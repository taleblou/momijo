...
fn __init__(out self, in_features: Int, num_classes: Int, w_init: Float64 = 0.01) -> None:
...
struct SGD:
    var lr: Float64
fn __init__(out self, lr: Float64 = 1e-2) -> None: self.lr = lr
...
fn __init__(out self, base_lr: Float64, step_size: Int, gamma: Float64 = 0.5) -> None:
...
fn __copyinit__(out self, other: Self) -> None:
        ...
        self.train_acc = other.train_acc
fn __moveinit__(out self, deinit other: Self) -> None:
        self.epoch_losses = other.epoch_losses
        self.train_acc = other.train_acc
