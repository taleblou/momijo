# Project:      Momijo
# Module:       src.momijo.nn.gan.began
# File:         began.mojo
...
#
# Notes:
#   - Structs: Linear, AE, Generator, BEGAN
#   - Key functions: _abs, _sum1d, _mean_abs_err, __init__, forward, __copyinit__, __moveinit__, _exp ...
...
fn __init__(out self, z_dim: Int, x_dim: Int, g_hidden: Int, d_hidden: Int, gamma: Float64 = 0.5, lambda_k: Float64 = 0.001) -> None:
