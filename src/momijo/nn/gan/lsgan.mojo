# Project:      Momijo
# Module:       src.momijo.nn.gan.lsgan
# File:         lsgan.mojo
...
#
# Notes:
#   - Structs: Linear, Generator, Discriminator, LSGAN
#   - Key functions: _sum1d, act_tanh_like, __init__, forward, __copyinit__, __moveinit__, __init__, forward ...
...
fn __init__(out self, z_dim: Int, x_dim: Int, g_hidden: Int, d_hidden: Int, a_fake: Float64 = 0.0, b_real: Float64 = 1.0, c_gen: Float64 = 1.0) -> None:
...
fn __copyinit__(out self, other: Self) -> None:
        self.G = other.G
        self.D = other.D
        self.a_fake = other.a_fake
        self.b_real = other.b_real
        self.c_gen = other.c_gen
fn __moveinit__(out self, deinit other: Self) -> None:
        self.G = other.G
        self.D = other.D
        self.a_fake = other.a_fake
