...
struct MaxPool2d:
    ...
    var ph: Int
    var pw: Int
fn __init__(out self, kernel_h: Int, kernel_w: Int, stride_h: Int = 0, stride_w: Int = 0, pad_h: Int = 0, pad_w: Int = 0) -> None:
        self.kh = kernel_h
        self.kw = kernel_w
...
fn __init__(out self, kernel_h: Int, kernel_w: Int, stride_h: Int = 0, stride_w: Int = 0, pad_h: Int = 0, pad_w: Int = 0, count_include_pad: Bool = False) -> None:
        self.kh = kernel_h
        self.kw = kernel_w
        self.sh = stride_h if stride_h > 0 else kernel_h
        self.sw = stride_w if stride_w > 0 else kernel_w
