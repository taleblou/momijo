# Project:      Momijo
# Module:       src.momijo.nn.layers.upsample
# File:         upsample.mojo
# Path:         src/momijo/nn/layers/upsample.mojo
#
...
# Notes:
#   - Structs: Upsample2d
#   - Key functions: zeros2d, zeros3d, zeros4d, clamp_int, coord_map, upsample2d_single_nearest, floori, lerp ...
...
fn __init__(out self, scale_h: Int = 0, scale_w: Int = 0, out_h: Int = 0, out_w: Int = 0, bilinear: Bool = False, align_corners: Bool = False) -> None:
...
fn __copyinit__(out self, other: Self) -> None:
        self.use_scale = other.use_scale
        self.scale_h = other.scale_h
        self.scale_w = other.scale_w
