# Project:      Momijo
# Module:       src.momijo.nn.layers.layernorm
# File:         layernorm.mojo
# Path:         src/momijo/nn/layers/layernorm.mojo
#
...
# Notes:
#   - Structs: LayerNorm
#   - Key functions: _zeros1d, _ones1d, _zeros2d, _mean_1d, _var_1d, _sqrt_pos, _norm_apply_affine_vec, __init__ ...
...
fn __init__(out self, normalized_shape: Int, eps: Float64 = 1e-5, affine: Bool = True) -> None:
