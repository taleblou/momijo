# Project:      Momijo
# Module:       src.momijo.nn.layers.linear
# File:         linear.mojo
# Path:         src/momijo/nn/layers/linear.mojo
#
...
# Notes:
#   - Structs: Linear
#   - Key functions: zeros1d, zeros2d, matvec, matmat, __init__, forward_vec, forward_batch, forward ...
