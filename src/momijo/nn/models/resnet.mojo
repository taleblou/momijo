# Project:      Momijo
# Module:       src.momijo.nn.models.resnet
# File:         resnet.mojo
# Path:         src/momijo/nn/models/resnet.mojo
#
...
#
# Notes:
#   - Structs: BatchNorm2dLite, Linear, BasicBlock, ResNetTiny
...
fn __init__(out self, in_ch: Int, out_ch: Int, stride: Int) -> None:
        self.in_ch = in_ch
        self.out_ch = out_ch
        self.stride = stride
...
fn __copyinit__(out self, other: Self) -> None:
        ...
        self.has_proj = other.has_proj
        self.w1 = other.w1
        self.w2 = other.w2
        self.wproj = other.wproj
fn __moveinit__(out self, deinit other: Self) -> None:
        self.in_ch = other.in_ch
        self.out_ch = other.out_ch
        self.stride = other.stride
