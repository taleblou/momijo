# Project:      Momijo
# Module:       src.momijo.nn.models.mobilenet_v2
# File:         mobilenet_v2.mojo
# Path:         src/momijo/nn/models/mobilenet_v2.mojo
#
...
#
# Notes:
#   - Structs: BatchNorm2dLite, Linear, InvertedResidual, MobileNetV2Tiny
#   - Key functions: zeros1d, zeros2d, zeros3d, zeros4d, relu6, relu6_chw, pad2d_chw, conv1x1_single ...
...
fn __init__(out self, num_features: Int, eps: Float64 = 1e-5) -> None:
...
fn __init__(out self, in_ch: Int, out_ch: Int, stride: Int, expand_ratio: Int) -> None:
        self.in_ch = in_ch
        self.out_ch = out_ch
        self.stride = stride
...
fn __copyinit__(out self, other: Self) -> None:
        ...
        self.expand_ch = other.expand_ch
        self.w_exp = other.w_exp
        self.bn1 = other.bn1
        self.w_dw = other.w_dw
        self.bn2 = other.bn2
        self.w_proj = other.w_proj
        self.bn3 = other.bn3
fn __moveinit__(out self, deinit other: Self) -> None:
        self.in_ch = other.in_ch
        self.out_ch = other.out_ch
...
fn __copyinit__(out self, other: Self) -> None:
        ...
        self.stem_w = other.stem_w
        self.stem_bn = other.stem_bn
        self.b1 = other.b1
        self.b2 = other.b2
        self.b3 = other.b3
        self.head_w = other.head_w
        self.head_bn = other.head_bn
