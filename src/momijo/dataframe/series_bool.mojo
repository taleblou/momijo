...
#
# Description:  dataframe.series_bool — Boolean Series utilities for Momijo DataFrame.
#               Storage (values + validity), cloning/copying, slicing/head,
#               selection (take/gather), logical ops (and/or/xor), and reductions.
#
...
#
# Notes:
#   - Structs: SeriesBool (data: List[Bool], valid: Bitmap, name: String).
#   - Key functions: clone, copy, len, get, is_valid, get_name, values,
#                    head, take, gather, count_valid, sum_true,
#                    logical_and/or/xor via internal _binary_op.
