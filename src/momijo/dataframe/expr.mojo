# Project:      Momijo
# Module:       src.momijo.dataframe.expr
# File:         expr.mojo
# Path:         src/momijo/dataframe/expr.mojo
#
# Description:  src.momijo.dataframe.expr — focused Momijo functionality with a stable public API.
...
#
# Notes:
#   - Structs: Ops, ExprKind, ConstVal, Pred, Expr
#   - Key functions: EQ, NE, GT, GE, LT, LE, __init__, __copyinit__ ...
...
fn __init__(out self) -> None:
        ...
        self.value() = ConstVal()
fn __init__(out self, col: String, op: Int, value: ConstVal) -> None:
        self.col = col
        self.op = op
        assert(self is not None, String("self is None"))
        self.value() = value
...
fn __init__(out self) -> None:
        ...
        self.p1 = Pred()
        self.p2 = Pred()
fn __init__(out self, kind: Int, p1: Pred, p2: Pred) -> None:
        self.kind = kind
        self.p1 = p1
        self.p2 = p2
fn __copyinit__(out self, other: Self) -> None:
