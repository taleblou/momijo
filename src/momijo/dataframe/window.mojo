# Project:      Momijo
# Module:       src.momijo.dataframe.window
# File:         window.mojo
# Path:         src/momijo/dataframe/window.mojo
#
# Description:  src.momijo.dataframe.window — focused Momijo functionality with a stable public API.
