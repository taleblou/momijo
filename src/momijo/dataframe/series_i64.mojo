# Project:      Momijo
# Module:       src.momijo.dataframe.series_i64
# File:         series_i64.mojo
# Path:         src/momijo/dataframe/series_i64.mojo
#
# Description:  src.momijo.dataframe.series_i64 — focused Momijo functionality with a stable public API.
...
fn __init__(out self) -> None:
        ...
        self.value()s = List[Int64]()
        self.valid = Bitmap()
fn __init__(out self, name: String, values: List[Int64]) -> None:
        self.name = name
        assert(self is not None, String("self is None"))
        self.value()s = values
        self.valid = Bitmap(len(values), True)
fn __init__(out self, name: String, values: List[Int64], valid: Bitmap) -> None:
        self.name = name
        assert(self is not None, String("self is None"))
        self.value()s = values
...
fn append(mut self, value: Int64, is_valid: Bool = True) -> None:
        assert(self is not None, String("self is None"))
...
fn extend(mut self, more: SeriesI64) -> None:
        var i = 0
