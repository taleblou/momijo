# Project:      Momijo
# Module:       src.momijo.dataframe.groupby
# File:         groupby.mojo
# Path:         src/momijo/dataframe/groupby.mojo
#
# Description:  src.momijo.dataframe.groupby — focused Momijo functionality with a stable public API.
...
# Notes:
#   - Structs: ModuleState
#   - Key functions: __init__, make_module_state, groupby_sum_f64
