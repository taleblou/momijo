# Project:      Momijo
# Module:       src.momijo.dist.sharding
# File:         sharding.mojo
# Path:         src/momijo/dist/sharding.mojo
#
# Description:  src.momijo.dist.sharding — focused Momijo functionality with a stable public API.
...
# Notes:
#   - Structs: ShardSpec
#   - Key functions: argmin_index, __init__, __copyinit__, __moveinit__, shard_tensor
