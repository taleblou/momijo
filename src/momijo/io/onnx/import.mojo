# Project:      Momijo
# Module:       src.momijo.io.onnx.import
# File:         import.mojo
# Path:         src/momijo/io/onnx/import.mojo
#
...
#
# Notes:
#   - Key functions: _read_u32_le, _read_u64_le, _read_i64_le, _read_str, parse_model


from momijo.core.config import off
from momijo.dataframe.series_bool import append
from momijo.io.onnx.opset import Model, TensorElemType, TensorProto, ValueInfo
from momijo.ir.llir.runtime_calls import assert
from momijo.tensor.tensor_base import nbytes
from momijo.utils.result import attrs, dims, ins, momijo, outs, payload, shape
from onnx.opset import Attribute, Graph, Model, Node, TensorElemType, TensorProto, ValueInfo
