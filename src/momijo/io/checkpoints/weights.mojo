# Project:      Momijo
# Module:       src.momijo.io.checkpoints.weights
# File:         weights.mojo
# Path:         src/momijo/io/checkpoints/weights.mojo
#
...
#
# Notes:
#   - Structs: ParamRef, StateDict
#   - Key functions: __init__, __copyinit__, __moveinit__, __init__, __setitem__, __getitem__, contains, __len__ ...
...
struct ParamRef:
    var name: String
    var tensor: Tensor
fn __init__(out self, name: String, tensor: Tensor) -> None:
        self.name = name
        self.tensor = tensor
...
fn __init__(out self) -> None:
    ...
    # Set parameter
fn __setitem__(mut self, key: String, value: Tensor) -> None:
