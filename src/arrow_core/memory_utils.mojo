...
# File: momijo/arrow_core/memory_utils.mojo

# NOTE:
# - Avoid functions that return a parameter directly (can trigger copy semantics).
# - Prefer patterns that create locals and return those locals (safe move for Movable types).

# A tiny box to carry a value; useful for explicit replace patterns without copying parameters.
