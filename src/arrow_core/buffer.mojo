...
# File: momijo/arrow_core/buffer.mojo
#
# NOTE:
# Pointer/allocator-free implementation for maximum compiler compatibility.
# Backed by List[UInt8]. Safe guards instead of asserts/exceptions.

# ---------- Tiny helpers (smoke tests & parity) ----------
...
struct Buffer:
    ...
    # ---- Constructors ---------------------------------------------------------
    fn __init__(out self, nbytes: Int):
        self.nbytes = nbytes
