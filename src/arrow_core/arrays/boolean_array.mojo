...
# File: momijo/arrow_core/arrays/boolean_array.mojo
...
struct BooleanArray(Copyable, Movable, Sized):
    ...
    fn __init__(out self):
        ...
        self.values = Bitmap(0, False)

    # Main constructor
    fn __init__(out self, values: Bitmap, length: Int, validity_bm: Bitmap):
    ...
    fn value(self, i: Int) -> Bool:
        if i < 0 or i >= self.len():
            return False
        return bitmap_get_valid(self.values, i)
